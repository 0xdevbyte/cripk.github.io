import {H as d, s as w} from "./index.ee4fe323.js";
const u = [];
function p(e, t=d) {
    let n;
    const o = new Set;
...
var h;
const A = ((h = globalThis.__sveltekit_czgi46) == null ? void 0 : h.base) ?? "";
var k;
const R = ((k = globalThis.__sveltekit_czgi46) == null ? void 0 : k.assets) ?? A
  , S = "1714517634277"
...
function P(e, t) {
    ...
    const o = e instanceof SVGAElement ? e.target.baseVal : e.target
      , r = !n || !!o || y(n, t) || (e.getAttribute("rel") || "").split(/\s+/).includes("external")
      , c = (n == null ? void 0 : n.origin) === m && e.hasAttribute("download");
    return {
        url: n,
        external: r,
        target: o,
...
function T() {
    ...
    async function o() {
        clearTimeout(n);
        try {
            const r = await fetch(`${R}/_app/version.json`, {
                headers: {
                    pragma: "no-cache",
            ...
            if (!r.ok)
                return !1;
            const a = (await r.json()).version !== S;
            return a && (e(!0),
            clearTimeout(n)),
            a
        } catch {
...
export {U as I, _ as P, O as S, x as a, P as b, V as c, q as d, A as e, z as f, L as g, Y as h, y as i, E as j, j as k, m as o, N as s};
