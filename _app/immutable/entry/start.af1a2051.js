import {o as me, t as _e} from "../chunks/index.ee4fe323.js";
import {S as Ke, a as ze, I as M, g as De, f as Ne, b as we, c as le, s as te, i as ye, d as J, e as V, o as qe, P as Me, h as Qe} from "../chunks/singletons.f630c90e.js";
import {u as Ze} from "../chunks/parse.bee59afc.js";
function et(n, r) {
    return n === "/" || r === "ignore" ? n : r === "never" ? n.endsWith("/") ? n.slice(0, -1) : n : r === "always" && !n.endsWith("/") ? n + "/" : n
}
function tt(n) {
...
window.fetch = (n,r)=>((n instanceof Request ? n.method : (r == null ? void 0 : r.method) || "GET") !== "GET" && ae.delete(Ee(n)),
Be(n, r));
const ae = new Map;
function lt(n) {
    const r = atob(n)
...
function ut(n, r, l) {
    if (ae.size > 0) {
        const c = Ee(n, l)
          , h = ae.get(c);
        if (h) {
            if (performance.now() < h.ttl && ["default", "force-cache", "only-if-cached", void 0].includes(l == null ? void 0 : l.cache))
...
function Ee(n, r) {
    let c = `script[data-sveltekit-fetched][data-url=${JSON.stringify(ninstanceof, Request ? n.url : n)}]`;
    if (r != null && r.headers || r != null && r.body) {
        const h = [];
        r.headers && h.push([...new Headers(r.headers)].join(",")),
        r.body && (typeof r.body == "string" || ArrayBuffer.isView(r.body)) && h.push(r.body),
        c += `[data-hash="${ct(...h)}"]`
    }
    return c
}
...
function pt(n) {
    const r = [];
    return {
        pattern: n === "/" ? /^\/$/ : new RegExp(`^${gt(n).map(c=>{
            const h = /^\[\.\.\.(\w+)(?:=(\w+))?\]$/.exec(c);
            if (h)
                return r.push({
                    name: h[1],
            ...
            return "/" + S.map((y,b)=>{
                if (b % 2) {
                    if (y.startsWith("x+"))
                        return ve(String.fromCharCode(parseInt(y.slice(2), 16)));
                    if (y.startsWith("u+"))
                        return ve(String.fromCharCode(...y.slice(2).split("-").map(O=>parseInt(O, 16))));
                    const u = dt.exec(y);
                    if (!u)
                        throw new Error(`Invalid param: ${y}. Params and matcher names can only have underscores and alphanumeric characters.`);
                    const [,j,D,C,N] = u;
                    return r.push({
                        name: C,
                        matcher: N,
...
function mt(n, r, l) {
    ...
    for (let m = 0; m < r.length; m += 1) {
        const y = r[m];
        let b = h[m - S];
        if (y.chained && y.rest && S && (b = h.slice(m - S, m + 1).filter(u=>u).join("/"),
        S = 0),
        b === void 0) {
            y.rest && (c[y.name] = "");
            continue
...
function _t({nodes: n, server_loads: r, dictionary: l, matchers: c}) {
    ...
    return Object.entries(l).map(([m,[y,b,u]])=>{
        ...
        return C.errors.length = C.layouts.length = Math.max(C.errors.length, C.layouts.length),
        C
    }
    );
    function w(m) {
...
async function vt(n, r) {
    ...
    for (const c in n)
        if (typeof ((l = n[c]) == null ? void 0 : l.then) == "function")
            return Object.fromEntries(await Promise.all(Object.entries(n).map(async([h,w])=>[h, await w])));
    return n
}
class ne {
    constructor(r, l) {
        this.status = r,
        typeof l == "string" ? this.body = {
            message: l
...
function xt(n, r) {
    ...
    let u = {
        ...
        error: null,
        url: null
    }, j = !1, D = !1, C = !0, N = !1, O = !1, T = !1, G = !1, F, U = (je = history.state) == null ? void 0 : je[M];
    U || (U = Date.now(),
    ...
    const fe = z[U];
    fe && (history.scrollRestoration = "manual",
    scrollTo(fe.x, fe.y));
    let H, W, Y;
    async function xe() {
        if (Y = Y || Promise.resolve(),
        await Y,
        !Y)
            return;
        Y = null;
        ...
        if (t === W && o) {
            ...
            o.props.page !== void 0 && (H = o.props.page),
            F.$set(o.props)
        }
    }
    function Re(e) {
        m.some(i=>i == null ? void 0 : i.snapshot) && (ee[e] = m.map(i=>{
            var t;
    ...
    async function re(e, {noScroll: i=!1, replaceState: t=!1, keepFocus: o=!1, state: a={}, invalidateAll: s=!1}, f, g) {
        return typeof e == "string" && (e = new URL(e,De(document))),
        ce({
            url: e,
            scroll: i ? te() : null,
            keepfocus: o,
    ...
    async function Ae(e) {
        return y = {
            id: e.id,
            promise: pe(e).then(i=>(i.type === "loaded" && i.state.error && (y = null),
            i))
        },
        y.promise
    }
    async function oe(...e) {
        const t = l.filter(o=>e.some(a=>o.exec(a))).map(o=>Promise.all([...o.layouts, o.leaf].map(a=>a == null ? void 0 : a[1]())));
        await Promise.all(t)
    }
    function Pe(e) {
        var o;
        ...
        const t = {
            ...
            to: {
                params: u.params,
                route: {
                    id: ((o = u.route) == null ? void 0 : o.id) ?? null
                },
        ...
        b.after_navigate.forEach(a=>a(t)),
        D = !0
    }
    async function X({url: e, params: i, branch: t, status: o, error: a, route: s, form: f}) {
        let g = "never";
        for (const p of t)
            (p == null ? void 0 : p.slash) !== void 0 && (g = p.slash);
        e.pathname = et(e.pathname, g),
        e.search = e.search;
        const v = {
            type: "loaded",
            state: {
            ...
            props: {
                constructors: wt(t).map(p=>p.node.component)
            }
        };
        ...
        for (let p = 0; p < Math.max(t.length, u.branch.length); p += 1) {
            const d = t[p]
              , P = u.branch[p];
            (d == null ? void 0 : d.data) !== (P == null ? void 0 : P.data) && (L = !0),
            d && (_ = {
                ..._,
                ...d.data
            },
        ...
        return (!u.url || e.href !== u.url.href || u.error !== a || f !== void 0 && f !== H.form || L) && (v.props.page = {
            error: a,
            params: i,
            route: {
    ...
    async function ue({loader: e, parent: i, url: t, params: o, route: a, server_data_node: s}) {
        var _, L, R;
        let f = null;
        const g = {
        ...
        return {
            ...
            slash: t.pathname === V || t.pathname === V + "/" ? "always" : ((R = v.universal) == null ? void 0 : R.trailingSlash) ?? (s == null ? void 0 : s.slash)
        }
    }
    function Ue(e, i, t, o, a) {
        ...
        if (!o)
            return !1;
        if (o.parent && e || o.route && i || o.url && t)
            return !0;
        for (const s of o.params)
            if (a[s] !== u.params[s])
                return !0;
        for (const s of o.dependencies)
            if (S.some(f=>f(new URL(s))))
                return !0;
        return !1
    }
    function de(e, i) {
    ...
    async function pe({id: e, invalidating: i, url: t, params: o, route: a}) {
        ...
        const p = v.map((E,k)=>{
            var K;
            const x = u.branch[k]
              , I = !!(E != null && E[0]) && ((x == null ? void 0 : x.loader) !== E[1] || Ue(A, R, L, (K = x.server) == null ? void 0 : K.uses, o));
            return I && (A = !0),
            I
        }
        );
        ...
        const $ = v.map(async(E,k)=>{
            ...
            const x = u.branch[k]
              , I = d == null ? void 0 : d[k];
            if ((!I || I.type === "skip") && E[1] === (x == null ? void 0 : x.loader) && !Ue(P, R, L, (he = x.universal) == null ? void 0 : he.uses, o))
                return x;
            if (P = !0,
            ...
            return ue({
                ...
                ,
                server_data_node: de(I === void 0 && E[0] ? {
                    type: "skip"
                } : I ?? null, E[0] ? x == null ? void 0 : x.server : void 0)
            })
        }
        );
        for (const E of $)
        ...
        for (let E = 0; E < v.length; E += 1)
            if (v[E])
                try {
                    ...
                    let x = 500, I;
                    if (d != null && d.includes(k))
                        x = k.status ?? x,
                        I = k.error;
                    else if (k instanceof ne)
                        x = k.status,
                        I = k.body;
                    else {
    ...
    async function ie({status: e, error: i, url: t, route: o}) {
        ...
        if (n.server_loads[0] === 0)
            try {
                ...
                (t.origin !== qe || t.pathname !== location.pathname || j) && await B(t)
            }
        const g = await ue({
            loader: c,
            url: t,
    ...
    function $e({url: e, type: i, intent: t, delta: o}) {
        ...
        const f = {
            ...
            cancel: ()=>{
                a = !0,
                s.reject(new Error("navigation was cancelled"))
            }
        };
        return O || b.before_navigate.forEach(g=>g(f)),
        a ? null : s
    }
    async function ce({url: e, scroll: i, keepfocus: t, redirect_count: o, details: a, type: s, delta: f, nav_token: g={}, accepted: v, blocked: _}) {
        var $, q, E;
        const L = Q(e, !1)
          , R = $e({
            url: e,
        ...
        v(),
        O = !0,
        D && J.navigating.set(R.navigation),
        W = g;
        let p = L && await pe(L);
        if (!p) {
            if (ye(e, V))
        ...
        if (p.type === "redirect")
            if (o >= 20)
                ...
                return re(new URL(p.location,e).href, {}, o + 1, g),
                !1;
        else
            (($ = p.props.page) == null ? void 0 : $.status) >= 400 && await J.updated.check() && await B(e);
        if (S.length = 0,
        G = !1,
        N = !0,
        be(A),
        Re(A),
        (q = p.props.page) != null && q.url && p.props.page.url.pathname !== e.pathname && (e.pathname = (E = p.props.page) == null ? void 0 : E.url.pathname),
        a) {
        ...
        D) {
            ...
            const k = (await Promise.all(b.on_navigate.map(x=>x(R.navigation)))).filter(x=>typeof x == "function");
            if (k.length > 0) {
                let x = function() {
                    b.after_navigate = b.after_navigate.filter(I=>!k.includes(I))
                };
                k.push(x),
                b.after_navigate.push(...k)
            }
            F.$set(p.props)
        } else
            Pe(p);
        ...
        if (await _e(),
        C) {
            const k = e.hash && document.getElementById(decodeURIComponent(e.hash.slice(1)));
            i ? scrollTo(i.x, i.y) : k ? k.scrollIntoView() : scrollTo(0, 0)
        }
        const P = document.activeElement !== d && document.activeElement !== document.body;
        !t && !P && Se(),
        C = !0,
    ...
    async function Ie(e, i, t, o) {
        return e.origin === qe && e.pathname === location.pathname && !j ? await ie({
            status: o,
            error: t,
            url: e,
            route: i
    ...
    function Xe() {
        ...
        w.addEventListener("touchstart", i, {
            passive: !0
        });
        const t = new IntersectionObserver(s=>{
            for (const f of s)
                f.isIntersecting && (oe(se(new URL(f.target.href))),
                t.unobserve(f.target))
        }
        ,{
            threshold: 0
        });
        ...
        function a() {
            ...
            for (const s of w.querySelectorAll("a")) {
                ...
                if (g || v)
                    continue;
                const _ = le(s);
                _.reload || (_.preload_code === Me.viewport && t.observe(s),
                _.preload_code === Me.eager && oe(se(f)))
            }
        }
        b.after_navigate.push(a),
        a()
    }
    function Z(e, i) {
        return e instanceof ne ? e.body : n.hooks.handleError({
            ...
            message: i.route.id === null && e instanceof bt ? "Not Found" : "Internal Error"
        }
    }
    return {
        after_navigate: e=>{
            me(()=>(b.after_navigate.push(e),
            ()=>{
        ...
        preload_data: async e=>{
            const i = new URL(e,De(document))
              , t = Q(i, !1);
            if (!t)
                throw new Error(`Attempted to preload a URL that does not belong to this app: ${i}`);
            await Ae(t)
        }
        ,
        preload_code: oe,
        ...
        _start_router: ()=>{
                ...
                !O) {
                    const a = Je(u, void 0, null, "leave")
                      , s = {
                        ...
                        cancel: ()=>{
                            o = !0,
                            a.reject(new Error("navigation was cancelled"))
                        }
                    };
            ...
            w.addEventListener("click", t=>{
                ...
                if (f === "_parent" || f === "_top") {
                    ...
                    return;
                const v = le(o);
                if (!(o instanceof SVGAElement) && a.protocol !== location.protocol && !(a.protocol === "https:" || a.protocol === "http:") || g)
                    return;
                if (s || v.reload) {
                    $e({
                        url: a,
                ...
                if (R !== void 0 && L === location.href.split("#")[0]) {
                    if (u.url.hash === a.hash) {
                        t.preventDefault(),
                        (A = o.ownerDocument.getElementById(R)) == null || A.scrollIntoView();
                        return
                    }
                    if (T = !0,
                    be(U),
            ...
            w.addEventListener("submit", t=>{
                ...
                if (((a == null ? void 0 : a.formMethod) || o.method) !== "get")
                    return;
                const f = new URL((a == null ? void 0 : a.hasAttribute("formaction")) && (a == null ? void 0 : a.formAction) || o.action);
                if (ye(f, V))
                    return;
                const g = t.target
                ...
                p && A.append(p, (a == null ? void 0 : a.getAttribute("value")) ?? ""),
            ...
            addEventListener("popstate", async t=>{
                ...
                (o = t.state) != null && o[M]) {
                    ...
                    if (((a = u.url) == null ? void 0 : a.href.split("#")[0]) === location.href.split("#")[0]) {
                        e(f),
                        z[U] = te(),
                        U = t.state[M],
                        scrollTo(s.x, s.y);
        ...
        ,
        _hydrate: async({status: e=200, error: i, node_ids: t, params: o, route: a, data: s, form: f})=>{
            j = !0;
            ...
            try {
                const _ = t.map(async(A,p)=>{
                    const d = s[p];
                    return d != null && d.uses && (d.uses = Ye(d.uses)),
                    ue({
                        loader: n.nodes[A],
                        url: g,
                        params: o,
...
async function He(n, r) {
    ...
    if ((h = c.headers.get("content-type")) != null && h.includes("text/html") && await B(n),
    !c.ok)
...
`);
                ...
                O.type === "redirect")
                    return w(O);
                if (O.type === "data")
                    (j = O.nodes) == null || j.forEach(T=>{
                        (T == null ? void 0 : T.type) === "data" && (T.uses = Ye(T.uses),
                        T.data = b(T.data))
                    }
                    ),
                    w(O);
...
function Se() {
    ...
    if (n)
        ...
        l !== null ? r.setAttribute("tabindex", l) : r.removeAttribute("tabindex");
        const c = getSelection();
        if (c && c.type !== "None") {
            const h = [];
            for (let w = 0; w < c.rangeCount; w += 1)
                h.push(c.getRangeAt(w));
            setTimeout(()=>{
                if (c.rangeCount === h.length) {
                    for (let w = 0; w < c.rangeCount; w += 1) {
                        const S = h[w]
                          , m = c.getRangeAt(w);
                        if (S.commonAncestorContainer !== m.commonAncestorContainer || S.startContainer !== m.startContainer || S.endContainer !== m.endContainer || S.startOffset !== m.startOffset || S.endOffset !== m.endOffset)
                            return
                    }
                    c.removeAllRanges()
                }
    ...
    ),
    {
        navigation: {
            from: {
                params: n.params,
                route: {
                    id: ((y = n.route) == null ? void 0 : y.id) ?? null
                },
                url: n.url
            },
            to: l && {
                ...
                route: {
                    id: ((b = r == null ? void 0 : r.route) == null ? void 0 : b.id) ?? null
                },
                url: l
            },
            willUnload: !r,
